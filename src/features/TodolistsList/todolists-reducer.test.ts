import {
  ...
  changeTodolistFilterAC, changeTodolistTitleTC, fetchTodolistsTC, FilterValuesType, removeTodolistTC,
  TodolistDomainType,
  todolistsReducer
...
test('correct todolist should be removed', () => {
  const endState = todolistsReducer(startState, removeTodolistTC.fulfilled({id: todolistId1}, "requestId", {todolistId: 'todolistId2'}))
...
test('correct todolist should change its name', () => {
  ...
  const action = changeTodolistTitleTC.fulfilled(payload,'reerweq',payload)
